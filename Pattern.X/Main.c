...
Conf_wheel_info       Wheel;
Conf_wheel_info_3D2S    Wheel_3D2S;
...
//                        SetState(((STATICTEXT*)(GOLFindObject(STE_178))), ST_DRAW);
        ...
        case RESET:
            ...
            if(Update_GLCD)
            {
                ...
                {
                    StSetText(((STATICTEXT*)(GOLFindObject(STE_252))), (XCHAR*)"GOOD");
                    SetState(((STATICTEXT*)(GOLFindObject(STE_252))), ST_DRAW);
                }
                Update_Time_Date();
                Update_Debug_blocks();
...
//    SetState(((RADIOBUTTON*) (GOLFindObject(RDB_614))), ST_HIDE);
    ...
    else
    {
        ...
        switch(Disp_Info.DS_mode)
        {
            ...
            sprintf(&var_buffer[8][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
...
void Update_SMCPU_Message(void)
{
        ...
        sprintf(&var_buffer[4][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
...
void Update_Reset_Message() {
    ...
    switch(Disp_Info.DS_mode)
        ...
        sprintf(&var_buffer_r[4][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
...
void Update_C_LCWS_Screen()
{
    ...
    switch(Disp_Info.DS_mode)
        ...
        sprintf(&var_buffer_r[1][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
...
void Update_C_3DP2S_Screen()
{
    ...
    {
        if(Wheel_3D2S.SF_RC == Wheel_3D2S.S_CF_RC)
        {
            if(Wheel_3D2S.SF_FC == Wheel_3D2S.S_CF_FC)
            {
                    PictSetBitmap(((PICTURE*)(GOLFindObject(PCB_336))), (void*)&No_Train);
                    SetState(((PICTURE*)(GOLFindObject(PCB_336))), PICT_DRAW);
            }
            else if(Wheel_3D2S.SF_FC > Wheel_3D2S.S_CF_FC)
             {
        ...
        else
        {
            ...
            else if(Wheel_3D2S.SF_RC < Wheel_3D2S.S_CF_RC)
             {
                        PictSetBitmap(((PICTURE*)(GOLFindObject(PCB_336))), (void*)&logo_small2_db2);
                        SetState(((PICTURE*)(GOLFindObject(PCB_336))), PICT_DRAW);
             }
    ...
    {
        if(Wheel_3D2S.EF_RC == Wheel_3D2S.E_CF_RC)
        {
            if(Wheel_3D2S.EF_FC == Wheel_3D2S.E_CF_FC)
            {
                PictSetBitmap(((PICTURE*)(GOLFindObject(PCB_337))), (void*)&No_Train);
                SetState(((PICTURE*)(GOLFindObject(PCB_337))), PICT_DRAW);
            }
            else if(Wheel_3D2S.EF_FC < Wheel_3D2S.E_CF_FC)
             {
        ...
        else
        {
            ...
            else if(Wheel_3D2S.EF_RC > Wheel_3D2S.E_CF_RC)
             {
                    PictSetBitmap(((PICTURE*)(GOLFindObject(PCB_337))), (void*)&logo_small2_db2);
                    SetState(((PICTURE*)(GOLFindObject(PCB_337))), PICT_DRAW);
             }
...
SF_error = GLCD_Info.CPU_Data[0][12];
        ...
        switch(Disp_Info.US_mode)
        {
            ...
            case RESET_APPLIED_AT_BOTH_UNITS:
                ...
                break;
            case SECTION_WAIT_FOR_PILOT_TRAIN:
                if(Wheel_3D2S.SF_RC==0  && Wheel_3D2S.S_CF_FC==0 && Wheel_3D2S.S_CF_RC==0 && Wheel_3D2S.E_CF_FC==0 && Wheel_3D2S.E_CF_RC==0 && Wheel_3D2S.EF_FC==0 && Wheel_3D2S.EF_RC==0) 
                {
                sprintf(&var_buffer_r[0][0], "Waiting for pilot train\n");
                sprintf(&var_buffer_r[1][0], "Waiting for pilot train\n");
                }
        ...
        sprintf(&var_buffer_r[5][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
    ...
    switch(Disp_Info.DS_mode)
        {
            ...
            sprintf(&var_buffer[5][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
...
//    }
    ...
    else if(Disp_Info.Unit_Type == UT_EF)
    {
            ...
            sprintf(&var_buffer[7][0], "C:0x%X%X|V:S%03d\n",DAC_sysinfo.Checksum.DWord.HiWord.Word,DAC_sysinfo.Checksum.DWord.LoWord.Word,CPU_Version);
...
void Update_Debug_blocks(void)
{
    ...
    var_count = GLCD_Info.CPU_Data[0][8];
    sprintf(&var_buffer[1][0],"%d\n",var_count);
...
int main(void)
{
    ...
    while(1)
    {
        Update_SPI_Data();
        sense_key = SW_WAKE;
//        for(temp_count = 0; temp_count <0x100; temp_count++);
        if(sense_key == SW_WAKE)
            sense_key = SW_WAKE;
        else
            sense_key = 0;
        while(SW_WAKE == 1);            
